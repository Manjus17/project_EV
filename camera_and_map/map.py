...
class MapWindow(QMainWindow):
    def open_map_window(self, x, y, station, location):
        map_dialog = MapDialog(x, y, station, location)
        map_dialog.exec_()
...
class MapDialog(QDialog):
    ...
    def __init__(self, x, y, station, location):
        super().__init__()
        # set window settings
        self.setWindowTitle(station + ", " + location)
